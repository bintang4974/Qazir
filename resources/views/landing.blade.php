...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo me-auto">
                <h1><a href="#services" class="text-primary">QAZIR</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="#about"><span>About</span> </a>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center"
                    data-aos="fade-up">
                    <div>
                        <h1>Aplikasi kasir untuk mempermudah bisnis, dengan website</h1>
                        <h2>QAZIR nihh boss senggol dong!!!!</h2>
    ...
    <div class="footer">
        <footer id="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-info">
                                ...
                                <p>
                                    Bagas adhe p <br>
                                    Tanah Merah, SURABAYA<br><br>
                                    <strong>Phone:</strong> +62 85648467135<br>
                                    <strong>Email:</strong> bagasadheprasetya@gmail.com<br>
                                </p>
            ...
            <div class="container">
                <div class="copyright">
                    &copy; Copyright <strong><span>Qazir</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
